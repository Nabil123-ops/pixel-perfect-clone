...
export const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { from: 0, to: 2 },
      { from: 1, to: 2 },
      { from: 3, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 4, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 5, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 6, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 12, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 13, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 15, to: 2, sourceHandle: "ai_languageModel", targetHandle: "ai_languageModel" },
      { from: 7, to: 2, sourceHandle: "ai_memory", targetHandle: "ai_memory" },
      { from: 8, to: 2, sourceHandle: "ai_tool", targetHandle: "ai_tool" },
      { from: 2, to: 9 },
      { from: 9, to: 10, sourceHandle: "out0" },
      { from: 9, to: 11, sourceHandle: "out1" },
      { from: 10, to: 11 },
    ],
  },
];
