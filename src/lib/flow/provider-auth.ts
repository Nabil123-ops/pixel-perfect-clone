...
export const PROVIDER_AUTH: ProviderAuthGuide[] = [
  {
    ...
    valueFormat: "sk-… (no \"Bearer \" prefix — added automatically)",
  ...
  },
  {
    ...
    credentialType: "apiKey",
    headerName: "Authorization",
    valueFormat: "<Gemini API key> (no \"Bearer \" prefix — added automatically)",
  ...
  },
  {
    ...
    credentialType: "apiKey",
    headerName: "Authorization",
    valueFormat: "gsk_… (no \"Bearer \" prefix — added automatically)",
  ...
  },
  {
    ...
    credentialType: "apiKey",
    headerName: "Authorization",
    valueFormat: "sk-or-… (no \"Bearer \" prefix — added automatically)",
  ...
  },
  {
    ...
    credentialType: "apiKey",
    headerName: "api-key",
    valueFormat: "<resource key> — sent raw, no prefix",
  ...
  },
  {
    ...
    headerName: "Authorization",
    valueFormat: "xoxb-… (no \"Bearer \" prefix — added automatically)",
  ...
  },
  {
    ...
    credentialType: "bearer",
    headerName: "Authorization",
    valueFormat: "secret_… (no \"Bearer \" prefix — added automatically; Notion-Version header is added for you)",
