...
export function Shell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="app-bg flex h-screen w-full overflow-hidden text-foreground">
      <aside className="glass-panel relative z-10 flex w-[236px] shrink-0 flex-col rounded-r-2xl border-y-0 border-l-0">
        <Link to="/" className="flex items-center gap-2.5 px-5 py-5">
          <span className="grid size-9 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-primary to-accent shadow-[var(--glow-primary)]">
            <img
              src="/logo.png"
              alt="n9n logo"
              width={20}
          ...
          <span className="min-w-0">
            <span className="block font-display text-base font-bold leading-none tracking-tight text-gradient-primary">n9n</span>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm transition-all duration-200 ${
                  active
                    ? "bg-gradient-to-r from-primary to-accent font-medium text-primary-foreground shadow-[var(--glow-primary)]"
        ...
        <div className="mt-auto space-y-3 p-3">
          <Link
            to="/account"
            className="flex items-center gap-2 rounded-xl border border-border/70 bg-white/50 px-3 py-2.5 text-xs transition-colors hover:bg-white/80"
          >
          ...
          <div className="glass relative overflow-hidden rounded-xl p-3.5">
            <p className="relative flex items-center gap-1.5 font-display text-xs font-semibold">
...
export function PageHeader({
  ...
  return (
    <header className="glass-panel relative z-0 grid grid-cols-[minmax(0,1fr)_auto] items-end gap-4 rounded-none border-x-0 border-t-0 px-8 pb-5 pt-7">
